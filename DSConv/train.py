...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='/root/autodl-tmp/yolov8-main/ultralytics/models/v8/yolov8x.yaml', help='model.yaml path')
    parser.add_argument('--weight', type=str, default='/root/autodl-tmp/yolov8-main/yolov8x.pt', help='pretrained model path')
    parser.add_argument('--cfg', type=str, default='hyp.yaml', help='hyperparameters path')
    parser.add_argument('--data', type=str, default='/root/autodl-tmp/VOC2007/data.yaml', help='data yaml path')
